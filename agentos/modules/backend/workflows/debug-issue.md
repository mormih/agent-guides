...
- Всегда используйте методы из `backend/skills/troubleshooting.md` для классификации и решения проблем (OOM, N+1, Race Conditions).
- Добавляйте новые логи по стандартам `backend/skills/observability.md`.
