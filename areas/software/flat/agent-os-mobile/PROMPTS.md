...
```text
Read `agent-os-mobile/AGENTS.md` and adopt its rules, skills loading strategy, and workflows as hard constraints.
...
```text
Using `agent-os-mobile/AGENTS.md`, implement: <feature description>.
...
```text
Using `agent-os-mobile/AGENTS.md`, run incident triage for: <incident summary>.
...
```text
Using `agent-os-mobile/AGENTS.md`, prepare release checklist for: <release scope>.
