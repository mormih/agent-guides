...
```text
Read `agent-os-security/AGENTS.md` and adopt its rules, skills loading strategy, and workflows as hard constraints.
...
```text
Using `agent-os-security/AGENTS.md`, implement: <feature description>.
...
```text
Using `agent-os-security/AGENTS.md`, run incident triage for: <incident summary>.
...
```text
Using `agent-os-security/AGENTS.md`, prepare release checklist for: <release scope>.
