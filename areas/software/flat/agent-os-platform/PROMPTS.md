...
```text
Read `agent-os-platform/AGENTS.md` and adopt its rules, skills loading strategy, and workflows as hard constraints.
...
```text
Using `agent-os-platform/AGENTS.md`, implement: <feature description>.
...
```text
Using `agent-os-platform/AGENTS.md`, run incident triage for: <incident summary>.
...
```text
Using `agent-os-platform/AGENTS.md`, prepare release checklist for: <release scope>.
