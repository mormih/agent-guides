# PROMPTS: agent-os-data-engineering
...
```text
Read `agent-os-data-engineering/AGENTS.md` and adopt its rules, skills loading strategy, and workflows as hard constraints.
...
```text
Using `agent-os-data-engineering/AGENTS.md`, implement: <feature description>.
...
```text
Using `agent-os-data-engineering/AGENTS.md`, run incident triage for: <incident summary>.
...
```text
Using `agent-os-data-engineering/AGENTS.md`, prepare release checklist for: <release scope>.
