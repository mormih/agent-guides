...
```text
Read `data-engineering/AGENTS.md` and adopt its rules, skills loading strategy, and workflows as hard constraints.
...
```text
Using `data-engineering/AGENTS.md`, implement: <feature description>.
...
```text
Using `data-engineering/AGENTS.md`, run incident triage for: <incident summary>.
...
```text
Using `data-engineering/AGENTS.md`, prepare release checklist for: <release scope>.
