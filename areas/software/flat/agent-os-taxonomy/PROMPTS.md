...
```text
Read `agent-os-taxonomy/AGENTS.md` and adopt its rules, skills loading strategy, and workflows as hard constraints.
...
```text
Using `agent-os-taxonomy/AGENTS.md`, implement: <feature description>.
...
```text
Using `agent-os-taxonomy/AGENTS.md`, run incident triage for: <incident summary>.
...
```text
Using `agent-os-taxonomy/AGENTS.md`, prepare release checklist for: <release scope>.
